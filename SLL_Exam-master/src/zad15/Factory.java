...
public class Factory {
    public static void orders(SLL<Order> active, SLL<Order> shipping) {
        SLLNode<Order> activeIterator = active.getFirst().succ;
        SLLNode<Order> mostPriorityOrder = active.getFirst();

        while (activeIterator != null) {
            if (activeIterator.element.getPriority() < mostPriorityOrder.element.getPriority()) {
                mostPriorityOrder = activeIterator;
            }
            activeIterator = activeIterator.succ;
        }

        shipping.insertLast(mostPriorityOrder.element);
    }
