...
public class MergeDLLs {
    public static void mergeDLLs(DLL<Integer> list1, DLL<Integer> list2) {
        DLLNode<Integer> mainIterator = list2.getFirst();
        ...
        while (mainIterator != null) {
            ...
            while (current != null) {
                if (current.element > mainIterator.element) {
                    list1.insertBefore(mainIterator.element, current);
                    list2.delete(mainIterator);
                    flag = false;
                    break;
                }
            ...
            if (flag) {
                list1.insertLast(mainIterator.element);
            }
